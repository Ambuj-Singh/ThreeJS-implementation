...
Also we will explore how to adapt according to varying frame rates of different screens so that the animation remains same across all the screens running that animation.
